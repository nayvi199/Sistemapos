...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- Aqui se muestra lo del header, igual tienes que llamar section contectheader -->
        @include('layouts.partials.contentheader')

        <!-- Main content -->
        <section class="content">
            <!-- Aqui se pone el contenido de la pagina, tienes que llamar en tu vista main-content -->
            @yield('main-content')
        </section><!-- /.content -->
    </div>

    <!-- /.En controlsiderbar es el menu de la izquiera  -->
